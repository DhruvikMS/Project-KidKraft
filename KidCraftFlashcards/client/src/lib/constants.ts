...
export const CATEGORIES = [
  ...
  { id: "birds", name: "Birds", color: "green" },
  { id: "colors", name: "Colors", color: "yellow" },
  { id: "fruit", name: "Fruit", color: "red" },
  { id: "numbers", name: "Numbers", color: "purple" },
  { id: "vegetables", name: "Vegetables", color: "emerald" },
  { id: "combo", name: "7-Pack Combo", color: "indigo" }
];
...
export const TESTIMONIALS = [
  {
    id: 1,
    content: "These flashcards have been amazing for my 4-year-old! She loves the colorful illustrations and has learned so much about animals. Highly recommend to any parent looking for educational tools.",
    name: "Sanya P.",
    title: "Mother of 2",
    avatar: "S",
    rating: 5
  ...
  {
    id: 2,
    content: "As a kindergarten teacher, I've tried many flashcards, but KidCraft's are exceptional. The quality is outstanding, and the children in my class are always excited to learn with them.",
    name: "Ravi M.",
  ...
  {
    id: 3,
    content: "I purchased the complete collection for my home daycare, and it's been a wonderful addition. The children from ages 2-5 all enjoy them, and they've helped develop vocabulary and recognition skills.",
    name: "Anita K.",
...
export const BLOG_POSTS = [
  {
    ...
    imageUrl: "https://res.cloudinary.com/dutdrr57w/image/upload/f_webp/v1745126151/background_5_d9ekzi.jpg"
  },
  {
    id: 2,
    ...
    imageUrl: "https://res.cloudinary.com/dutdrr57w/image/upload/f_webp/v1745126165/combo_11_rrscox.jpg"
  },
  {
    id: 3,
    ...
    imageUrl: "https://res.cloudinary.com/dutdrr57w/image/upload/f_webp/v1745126151/background2_h1jpfm.jpg"
  }
];
